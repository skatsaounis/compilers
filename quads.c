...
char * symbol_type (SymbolEntry * p) {
    if (p == NULL)
        return strdup("-");
    switch (p->entryType) {
        case ENTRY_CONSTANT:               return strdup("constant");         break;
        case ENTRY_FUNCTION:               return strdup("function");         break;
        case ENTRY_PARAMETER:              return strdup("parameter");        break;
        case ENTRY_VARIABLE:               return strdup("variable");         break;
        case ENTRY_TEMPORARY:              return strdup("temporary");        break;
    ...
    switch (p->entryType) {
        case ENTRY_PARAMETER:
            switch (p->u.eParameter.mode) {
                case PASS_BY_VALUE:        return strdup("value");            break;
                case PASS_BY_REFERENCE:    return strdup("reference");        break;
                default:                   /* nothing */                      break;
            }
            break;
    ...
    switch (p->entryType) {
        case ENTRY_CONSTANT:
            switch (p->u.eConstant.type->kind) {
                case TYPE_VOID:            return strdup("list");             break;
                case TYPE_INTEGER:         return strdup("integer");          break;
                case TYPE_BOOLEAN:         return strdup("boolean");          break;
                case TYPE_CHAR:            return strdup("char");             break;
                case TYPE_IARRAY:
                    switch (p->u.eConstant.type->refType->kind) {
                        ...
                        case TYPE_BOOLEAN: return strdup("boolean");          break;
                        case TYPE_CHAR:    return strdup("char");             break;
                        case TYPE_IARRAY:  return strdup("iarray");           break;
                        case TYPE_LIST:    return strdup("list");             break;
                        default:           /* nothing */                      break;
                    }
                    break;
                case TYPE_LIST:
        ...
        case ENTRY_FUNCTION:
            switch (p->u.eFunction.resultType->kind) {
                case TYPE_VOID:            return strdup("procedure");        break;
                case TYPE_BOOLEAN:
                case TYPE_CHAR:            return strdup("byte");             break;
                default:                   return strdup("word");             break;
            }
            break;
    }
    return NULL;
...
Type lookup_type_find_b (SymbolEntry * p) {
    Type value;
    switch (p->entryType) {
        case ENTRY_CONSTANT:               value = p->u.eConstant.type;       break;
        case ENTRY_FUNCTION:               value = p->u.eFunction.resultType; break;
        case ENTRY_PARAMETER:              value = p->u.eParameter.type;      break;
        case ENTRY_VARIABLE:               value = p->u.eVariable.type;       break;
        case ENTRY_TEMPORARY:              value = p->u.eTemporary.type;      break;
    }
    return value;
}
